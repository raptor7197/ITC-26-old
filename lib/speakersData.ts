...
export const keynoteSpeakers = [
  ...
  },
  {
    ...
    description:
      "Today's test and reliability practices cannot meet the levels of thoroughness demanded by today's (and future) systems, from (autonomous) cars to the cloud. Too many defective compute chips escape existing manufacturing tests – at least an order of magnitude more than industry targets across compute chip types deployed in data centers. Several hyperscalers have recently reported alarming system-level effects, such as Silent Data Corruptions (SDCs), caused by test escapes. Left unaddressed, these SDCs pose a major threat to reliable computing. Business-as-usual approaches, including cell-aware test patterns and existing system-level testing, are inadequate. Future architectures, from chiplets to 3D, create even bigger challenges. These create golden opportunities for new \"System-Driven\" approaches – from extremely thorough testing, deemed impossible today, all the way to cost-effective tolerance and prediction of failures in hardware during system operation.",
    bio: [
  ...
  },
  {
    ...
    bio: [
      "Senthilkumar Dhamodharan is Vice-President of Semiconductor Test Engineering at Caliber, where he leads the Test Engineering Division responsible for validating SoC, PMIC, Digital, Mixed-Signal, and RF products across ATE and bench platforms. With over 19 years of experience at industry leaders including Qualcomm, AMD, and NXP, he has built deep expertise in semiconductor test, physical design, DFT, and high-volume manufacturing. He also drives strategic initiatives in intellectual property development and leads a high-performance engineering organization of more than 250 test engineers. He holds a Master's degree in VLSI Design from Anna University.",
      "Drawing on extensive leadership across semiconductor validation, manufacturing test, and engineering strategy, Senthil has played a pivotal role in advancing innovative test methodologies for complex silicon products. His experience in building scalable engineering organizations and driving next-generation test solutions provides him with valuable insights into the evolving landscape of semiconductor testing and intelligent silicon.",
    ],
...
export const industrySpeakers = [
  ...
  },
  {
    ...
    affiliation: "SanDisk",
    title: "Testing High-Speed NAND Flash Interface I/Os for Silicon Quality and Production Readiness.",
    description: "This talk shares an industry perspective on testing high-speed flash interface I/Os for NAND flash-based storage systems, covering  validation, signal integrity, margin assessment, silicon debug, and production screening to improve silicon quality and production readiness.",
    bio: [
  ...
  },
  {
    ...
    authors: [
      ...
      },
      {
        ...
        bio: "Senthilkumar Dhamodharan is Vice-President of Semiconductor Test Engineering at Caliber, where he leads the Test Engineering Division responsible for validating SoC, PMIC, Digital, Mixed-Signal, and RF products across ATE and bench platforms. With over 19 years of experience at industry leaders including Qualcomm, AMD, and NXP, he has built deep expertise in semiconductor test, physical design, DFT, and high-volume manufacturing. He also drives strategic initiatives in intellectual property development and leads a high-performance engineering organization of more than 250 test engineers. He holds a Master's degree in VLSI Design from Anna University.\n\nDrawing on extensive leadership across semiconductor validation, manufacturing test, and engineering strategy, Senthil has played a pivotal role in advancing innovative test methodologies for complex silicon products. His experience in building scalable engineering organizations and driving next-generation test solutions provides him with valuable insights into the evolving landscape of semiconductor testing and intelligent silicon.",
        image: "/images/senthilkumar.png",
        imageClassName: "object-[center_10%]",
      },
      {
