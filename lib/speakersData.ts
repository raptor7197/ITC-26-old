...
export const keynoteSpeakers = [
  ...
  },
  {
    ...
    description:
      "As semiconductor systems become increasingly complex, conventional test and reliability methodologies are struggling to keep pace. Test escapes and silent data corruption are emerging as critical threats to reliable computing, particularly in hyperscale data centers and safety-critical applications. With the transition to advanced architectures such as chiplets and 3D integration, the need for more comprehensive, system-driven test strategies has never been greater. This keynote explores the limitations of current approaches and examines emerging methodologies that enable deeper fault detection, predictive failure analysis, and cost-effective reliability throughout a system's operational lifetime.",
    bio: [
