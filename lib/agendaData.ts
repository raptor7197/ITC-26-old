    ...
    slots: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { hall: "Grand Victoria 2", subtitle: "Tutorial Track 2(b)", sessionChair: "Session chair: Rajit Karmakar", title: "The Seamless Integration of Packetized scan and In-system test with Advanced ATE Equipment", items: ["Lee Harrison and Peter Orlando (Siemens EDA)"] },
