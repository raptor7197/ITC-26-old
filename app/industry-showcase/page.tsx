      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 mt-16">
        <div className="flex flex-col gap-8 w-full">
          {industryShowcaseData.map((showcase) => (
            <div key={showcase.id} className="w-full bg-[#0b284e]/60 border border-[#00b0f0]/40 rounded-lg p-10 md:p-14 flex flex-col items-center justify-center text-center shadow-lg backdrop-blur-sm shadow-[#00b0f0]/10">
              <h2 className="font-black text-4xl sm:text-5xl md:text-[52px] tracking-tight mb-2 text-white drop-shadow-md">
                {showcase.name}
              </h2>
              <div className="h-[2px] w-24 bg-[#00b0f0]/50 mb-6 rounded-full mt-4"></div>
