...
import { postersData } from "@/lib/speakersData";
      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 mt-16">
        <div className="flex flex-col gap-8 w-full">
          {postersData.map((poster) => (
            <div key={poster.id} className="w-full bg-[#0b284e]/60 border border-[#00b0f0]/40 rounded-lg p-10 md:p-14 flex flex-col items-center justify-center text-center shadow-lg backdrop-blur-sm shadow-[#00b0f0]/10">
              <h2 className="font-black text-3xl sm:text-4xl md:text-[42px] tracking-tight mb-4 text-white drop-shadow-md">
                {poster.name}
              </h2>
              {poster.affiliation && (
