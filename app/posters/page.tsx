      ...
      <div className="relative z-10 w-full max-w-[1100px] flex flex-col mx-auto gap-16 px-page mt-10">
        <div className="flex flex-col gap-8 w-full">
          {postersData.map((poster) => (
            <div key={poster.id} className="w-full bg-gradient-to-br from-white/[0.05] to-transparent backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-10 md:p-14 flex flex-col items-center justify-center text-center shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-white/20 transition-all duration-300">
