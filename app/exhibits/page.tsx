...
import { exhibitsData } from "@/lib/speakersData";
      ...
      <div className="relative z-10 w-full max-w-[1100px] flex flex-col mx-auto gap-8 px-page mt-8">
        <div className="flex flex-col gap-6 w-full">
          {exhibitsData.map((exhibit) => (
            <div key={exhibit.id} className="w-full bg-gradient-to-br from-white/[0.05] to-transparent backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col items-center justify-center text-center shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-white/20 transition-all duration-300">
