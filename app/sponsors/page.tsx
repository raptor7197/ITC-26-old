...
export default function SponsorsPage() {
  return (
    <main className="min-h-screen relative text-white font-poppins selection:bg-white/20">
      <div className="relative z-10 pt-[150px] pb-20 w-full px-page max-w-[1360px] mx-auto flex flex-col">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            make IEEE ITC India 2026 a premier event for the semiconductor test
            community.
          </p>
