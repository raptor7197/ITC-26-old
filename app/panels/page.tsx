      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 mt-16">
        <div className="flex flex-col gap-8 w-full">
          {panelsData.map((panel) => (
            <div key={panel.id} className="w-full bg-[#0b284e]/60 border border-[#00b0f0]/40 rounded-lg p-10 md:p-14 flex flex-col items-center justify-center text-center shadow-lg backdrop-blur-sm shadow-[#00b0f0]/10">
