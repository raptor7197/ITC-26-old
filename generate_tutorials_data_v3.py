...
tutorials = [
  {
    "id": "342",
    "title": "Customer Centric Post Silicon Validation Approach for System on Chip (SoC)",
  ...
  {
    "id": "497",
    "title": "Mission Mode Scan Dump Using IJTAG and TAP Customization: Architecture, Implementation, and Practical Considerations",
  ...
  },
  {
    ...
    "authors": [
      ...
      },
      {
        ...
        "affiliation": "Director of Semiconductor Test Engineering at Caliber Interconnect Solutions",
...
with open("tutorials_data_v3.json", "w") as f:
