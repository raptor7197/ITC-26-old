  ...
  return (
    <div className="flex w-full min-w-0 flex-1 flex-col sm:items-end justify-center">
      <a
        ...
        className="min-h-[44px] w-full shrink-0 bg-blue-800 px-8 font-poppins font-medium text-white shadow-sm
                  flex items-center justify-center whitespace-nowrap
                  text-[clamp(0.875rem,2.2vw,1.125rem)] rounded-sm
                  sm:w-auto sm:min-w-[7.5rem] md:min-w-[8.5rem] sm:min-h-[40px]
                  hover:bg-blue-500/85 active:scale-[0.99] transition-transform"
      >
        Subscribe
      </a>
    </div>
