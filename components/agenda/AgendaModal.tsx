              ...
              {data.abstract !== undefined ? (
                <div className="flex flex-col w-full">
                  ...
                  <div className="mb-8 text-center md:text-left">
                    ...
                    {data.bestPaperNomination && (
                      <div className="mt-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 text-amber-300 text-xs font-bold tracking-widest uppercase shadow-[0_0_15px_rgba(245,158,11,0.2)]">
